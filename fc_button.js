...
function getBuildingTooltip(purchaseRec) {
  ...
  parent.append(
    $('<div>')
      .addClass('name')
      .text(purchaseRec.purchase.name)
  );
  parent.append(
    $('<div>')
  ...
  parent.append(
    $('<div>')
      ...
      .html(purchaseRec.purchase.desc)
  );
    ...
    var purchaseRec = recommendations.filter(function(a) {
      ...
      button = $('<div>')
        ...
        .append(
          $('<div>')
            .addClass('icon')
            .attr('style', 'background-image:url(img/' + me.icon + '.png);')
        ),
...
function updateTimers() {
  ...
  if (purchaseTotal > 0) {
    t_draw.push({
      ...
      c1: 'rgba(17, 17, 17, 1)',
      name: nextPurchase().purchase.name + ' Completion Time',
      display: timeDisplay(
  ...
  Game.UpdateMenu = function() {
    ...
    var currentCookies,
      ...
      menu = $('#menu')
        ...
        .append(
          $('<div>')
            .addClass('section')
            .html('Frozen Cookies v ' + FrozenCookies.version)
        ),
      subsection = $('<div>')
        .addClass('subsection')
        .append(
      ...
      chocolateRecoup =
        ...
        (recommendation.delta_cps * 20);

    subsection.append(
      $('<div>')
        .addClass('listing')
        .html('<b>Next Purchase:</b> ' + recommendation.purchase.name)
    );
    if (isChained) {
      subsection.append(
        $('<div>')
          .addClass('listing')
          .html(
            '<b>Building Chain to:</b> ' + chainRecommendation.purchase.name
          )
      );
    }
    subsection.append(
    ...
    subsection.append(
      $('<div>')
        .addClass('listing')
        .html(
          '<b>Estimated Actual completion time:</b> ' +
            timeDisplay(
              divCps(
                recommendation.cost + bankLevel.cost - Game.cookies,
                effectiveCps()
    ...
    if (isChained) {
      subsection.append(
        $('<div>')
          .addClass('listing')
          .html(
            '<b>Time till Chain completion:</b> ' +
              timeDisplay(
                divCps(
                  Math.max(
                    0,
    ...
    subsection.append(
      $('<div>')
        .addClass('listing')
        .html('<b>Cost:</b> ' + Beautify(recommendation.cost))
    );
    subsection.append(
      $('<div>')
        .addClass('listing')
        .html('<b>Golden Cookie Bank:</b> ' + Beautify(bankLevel.cost))
    );
    subsection.append(
      $('<div>')
        .addClass('listing')
        .html(
          '<b>Base &#916; CPS:</b> ' + Beautify(recommendation.base_delta_cps)
        )
    );
    subsection.append(
      $('<div>')
        .addClass('listing')
        .html('<b>Full &#916; CPS:</b> ' + Beautify(recommendation.delta_cps))
    );
    subsection.append(
      $('<div>')
        .addClass('listing')
        .html(
          '<b>Purchase Efficiency:</b> ' + Beautify(recommendation.efficiency)
        )
    );
    if (isChained) {
      subsection.append(
    ...
    if (bankLevel.efficiency > 0) {
      subsection.append(
        $('<div>')
          .addClass('listing')
          .html(
            '<b>Golden Cookie Efficiency:</b> ' + Beautify(bankLevel.efficiency)
          )
      );
    }
    ...
    subsection.append(
      $('<div>')
        .addClass('title')
        .html('Golden Cookie Information')
    );
    ...
    subsection.append(
      $('<div>')
        .addClass('listing')
        .html(
          '<b>Current Average Cookie Value' +
            targetTxt +
            maxTxt +
            ':</b> ' +
    ...
    if (!isTarget) {
      subsection.append(
        $('<div>')
          .addClass('listing')
          .html(
            '<b>Target Average Cookie Value:</b> ' +
    ...
    subsection.append(
      $('<div>')
        .addClass('listing')
        .html('<b>Max Lucky Cookie Value:</b> ' + Beautify(maxLuckyValue()))
    );
    subsection.append(
      $('<div>')
        .addClass('listing')
        .html(
          '<b>Cookie Bank Required for Max Lucky:</b> ' +
            Beautify(maxLuckyBank())
        )
    );
    subsection.append(
      $('<div>')
    ...
    subsection.append(
      $('<div>')
        .addClass('listing')
        .html(
          '<b>Cookie Bank Required for Max Chain:</b> ' + Beautify(chainBank())
        )
    );
    subsection.append(
      $('<div>')
    ...
    subsection.append(
      $('<div>')
        .addClass('listing')
        .html('<b>Golden Cookie Clicks:</b> ' + Beautify(Game.goldenClicks))
    );
    subsection.append(
      $('<div>')
        .addClass('listing')
        .html(
          '<b>Missed Golden Cookie Clicks:</b> ' +
    ...
    subsection.append(
      $('<div>')
        .addClass('listing')
        .html(
          '<b>Last Golden Cookie Effect:</b> ' + Game.shimmerTypes.golden.last
        )
    );
    ...
    subsection.append(
      $('<div>')
        .addClass('title')
        .html('Heavenly Chips Information')
    );
    currPrestige = Game.prestige;
    resetPrestige = Game.HowMuchPrestige(
      Game.cookiesReset +
        Game.cookiesEarned +
        wrinklerValue() +
        chocolateValue()
    ...
    subsection.append(
      $('<div>')
        .addClass('listing')
        .html('<b>HC Now:</b> ' + Beautify(Game.heavenlyChips))
    );
    subsection.append(
      $('<div>')
        .addClass('listing')
        .html('<b>HC After Reset:</b> ' + Beautify(resetHC))
    );
      ...
      if (FrozenCookies.maxHCPercent > 0) {
        subsection.append(
          $('<div>')
            .addClass('listing')
            .html(
              '<b>Max HC Gain/hr:</b> ' + Beautify(FrozenCookies.maxHCPercent)
            )
        );
      }
      subsection.append(
    ...
    if (FrozenCookies.setHarvestBankPlant) {
      ...
      subsection.append(
        $('<div>')
          .addClass('title')
          .html('Harvesting Information')
      );
      subsection.append(
        $('<div>')
          .addClass('listing')
          .html('<b>Base CPS:</b> ' + Beautify(baseCps()))
      );
      subsection.append(
        $('<div>')
          .addClass('listing')
          .html('<b>Plant to harvest:</b> ' + FrozenCookies.harvestPlant)
      );
      subsection.append(
        $('<div>')
          .addClass('listing')
          .html(
            '<b>Minutes of CpS:</b> ' + FrozenCookies.harvestMinutes + ' min'
          )
      );
      subsection.append(
        $('<div>')
    ...
    subsection.append(
      $('<div>')
        .addClass('listing')
        .html('<b>Base CPS' + clickStr + baseChosen + ':</b> ' + Beautify(cps))
    );
    subsection.append(
      $('<div>')
        .addClass('listing')
    ...
    subsection.append(
      $('<div>')
        .addClass('listing')
        .html('<b>Estimated Effective CPS:</b> ' + Beautify(effectiveCps()))
    );
    if (Game.HasUnlocked('Chocolate egg') && !Game.Has('Chocolate egg')) {
      subsection.append(
        $('<div>')
          .addClass('listing')
          .html('<b>Chocolate Egg Value:</b> ' + Beautify(chocolateValue()))
      );
    ...
    if (liveWrinklers().length > 0) {
      subsection.append(
        $('<div>')
          .addClass('listing')
          .html('<b>Wrinkler Value:</b> ' + Beautify(wrinklerValue()))
      );
    }
    menu.append(subsection);
    ...
    subsection.append(
      $('<div>')
        .addClass('title')
        .html('Internal Information')
    );
    buildTable = $('<table id="fcEfficiencyTable"/>').html(
      '<tr><th>Building</th><th>Eff%</th><th>Efficiency</th><th>Cost</th><th>&#916; CPS</th></tr>'
    );
      ...
      buildTable.append(
        $(
          '<tr><td><b>' +
            ...
            '%</td><td>' +
            Beautify(rec.efficiency) +
            '</td><td>' +
            Beautify(rec.cost) +
            '</td><td>' +
            Beautify(rec.delta_cps) +
            '</td></tr>'
        )
      );
    });
        ...
        buildTable.append(
          $(
            '<tr><td colspan="2"><b>' +
              k +
              (Game.elderWrath === v ? ' (*)' : '') +
              '</b></td><td colspan="2" title="Ratio of Effective CPS vs Base CPS">' +
              Beautify(effectiveCps(Game.cookies, v) / baseCps()) +
              '</td><td>' +
              Beautify(effectiveCps(Game.cookies, v) - effectiveCps()) +
              '</td></tr>'
          )
        );
      }
